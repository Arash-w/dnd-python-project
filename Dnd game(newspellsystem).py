...
def main(spelllist= [["chivalrous"], ["fireball","avada kadavera"], ["crossbow"]]):
  ...
  _______                     ____                     _   _____  _____   _____ ___  
 |__   __|                   |  _ \                   | | |  __ \|  __ \ / ____|__ \ 
    | |_   _ _ __ _ __ ______| |_) | __ _ ___  ___  __| | | |__) | |__) | |  __   ) |
    | | | | | '__| '_ \______|  _ < / _` / __|/ _ \/ _` | |  _  /|  ___/| | |_ | / / 
    | | |_| | |  | | | |     | |_) | (_| \__ \  __/ (_| | | | \ \| |    | |__| ||_|  
    |_|\__,_|_|  |_| |_|     |____/ \__,_|___/\___|\__,_| |_|  \_\_|     \_____|(_)  """))))
    ...
    SPELL:"""+spelllist[0][0])
        ...
        pDEF = 50
        spell = 25
        spelllist = spells[0][0]
    elif Class == "2":
        print("""mage:
    HP: 350
    ATK: 100
    DEF: 30
    SPELLS:"""+spelllist[1][0], spelllist[1][1])
        pHP = 350
        pATK = 100
        pDEF = 30
        spell = 75
        spelllist = spells[1][0],spells[1][1]
    elif Class == "3":
        print("""ranger:
    HP: 400
    ATK: 75
